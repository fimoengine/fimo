...
pub fn build(b: *std.Build) void {
    ...
    //                 fimo_tasks.addAssemblyFile(context_path.path(b, "asm/jump_arm64_aapcs_pe_armasm.asm"));
    //                 fimo_tasks.addAssemblyFile(context_path.path(b, "asm/make_arm64_aapcs_pe_armasm.asm"));
    //                 fimo_tasks.addAssemblyFile(context_path.path(b, "asm/ontop_arm64_aapcs_pe_armasm.asm"));
    //             }
    //         },
    //         .macos => {
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/jump_arm64_aapcs_macho_gas.S"));
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/make_arm64_aapcs_macho_gas.S"));
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/ontop_arm64_aapcs_macho_gas.S"));
    //         },
    //         else => {
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/jump_arm64_aapcs_elf_gas.S"));
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/make_arm64_aapcs_elf_gas.S"));
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/ontop_arm64_aapcs_elf_gas.S"));
    //         },
    //     },
    //     .riscv64 => {
    //         fimo_tasks.addAssemblyFile(context_path.path(b, "asm/jump_riscv64_sysv_elf_gas.S"));
    //         fimo_tasks.addAssemblyFile(context_path.path(b, "asm/make_riscv64_sysv_elf_gas.S"));
    //         fimo_tasks.addAssemblyFile(context_path.path(b, "asm/ontop_riscv64_sysv_elf_gas.S"));
    //     },
    //     .x86_64 => switch (target.result.os.tag) {
    //         .windows => {
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/jump_x86_64_ms_pe_clang_gas.S"));
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/make_x86_64_ms_pe_clang_gas.S"));
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/ontop_x86_64_ms_pe_clang_gas.S"));
    //         },
    //         .macos => {
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/jump_i386_x86_64_sysv_macho_gas.S"));
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/jump_x86_64_sysv_macho_gas.S"));
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/make_i386_x86_64_sysv_macho_gas.S"));
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/make_x86_64_sysv_macho_gas.S"));
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/ontop_x86_64_sysv_macho_gas.S"));
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/ontop_i386_x86_64_sysv_macho_gas.S"));
    //         },
    //         else => {
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/jump_x86_64_sysv_elf_gas.S"));
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/make_x86_64_sysv_elf_gas.S"));
    //             fimo_tasks.addAssemblyFile(context_path.path(b, "asm/ontop_x86_64_sysv_elf_gas.S"));
    //         },
    //     },
    //     else => @panic("Invalid arch"),
    // }
