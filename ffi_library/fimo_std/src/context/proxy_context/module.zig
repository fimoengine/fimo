...
pub const ParameterAccessGroup = enum(c.FimoModuleParamAccess) {
...
pub const Export = extern struct {
    ...
    next: ?*Context.TaggedInStruct = null,
    export_abi: i32 = c.FIMO_MODULE_EXPORT_ABI,
    name: [*:0]const u8,
    description: ?[*:0]const u8 = null,
    author: ?[*:0]const u8 = null,
    license: ?[*:0]const u8 = null,
...
const ffi = struct {
    ...
    export fn fimo_module_set_append_modules(
        ...
        _ = module_set.addModulesFromPathCustom(
            ctx.module(),
            if (module_path) |p| std.mem.span(p) else null,
            filter_data,
            filter,
            &err,
        ) catch undefined;
    ...
    export fn fimo_module_param_set_public(
        ...
        const ctx = Context.initC(context);
        return OpaqueParameter.writePublicFfi(
            ctx.module(),
            value,
            value_type,
            module_name,
    ...
    export fn fimo_module_param_get_public(
        context: c.FimoContext,
        value: *anyopaque,
        value_type: *ParameterType,
        module_name: [*:0]const u8,
        ...
        const ctx = Context.initC(context);
        return OpaqueParameter.readPublicFfi(
            ctx.module(),
            value,
            value_type,
            module_name,
    ...
    export fn fimo_module_param_set_dependency(
        module: *const OpaqueInstance,
        value: *const anyopaque,
        value_type: ParameterType,
        module_name: [*:0]const u8,
        ...
        return OpaqueParameter.writeDependencyFfi(
            module,
            value,
            value_type,
            module_name,
    ...
    export fn fimo_module_param_get_dependency(
        module: *const OpaqueInstance,
        value: *anyopaque,
        value_type: *ParameterType,
        module_name: [*:0]const u8,
        ...
        return OpaqueParameter.readDependencyFfi(
            module,
            value,
            value_type,
            module_name,
    ...
    export fn fimo_module_param_set_private(
        module: *const OpaqueInstance,
        value: *const anyopaque,
        value_type: ParameterType,
        param: *OpaqueParameter,
    ) c.FimoResult {
        return param.writePrivateFfi(module, value, value_type);
    }

    export fn fimo_module_param_get_private(
        module: *const OpaqueInstance,
        value: *anyopaque,
        value_type: *ParameterType,
        param: *const OpaqueParameter,
    ) c.FimoResult {
        return param.readPrivateFfi(module, value, value_type);
    }

    export fn fimo_module_param_set_inner(
        module: *const OpaqueInstance,
        value: *const anyopaque,
        value_type: ParameterType,
        param: *OpaqueParameterData,
    ) c.FimoResult {
        return OpaqueParameterData.writeFfi(
            module,
            value,
            value_type,
            param,
    ...
    export fn fimo_module_param_get_inner(
        module: *const OpaqueInstance,
        value: *anyopaque,
        value_type: *ParameterType,
        param: *const OpaqueParameterData,
    ) c.FimoResult {
        return OpaqueParameterData.readFfi(
            module,
            value,
            value_type,
            param,
