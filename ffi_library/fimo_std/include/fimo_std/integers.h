...
#define FIMO_UINT_MACROS_(T, SUFFIX, AFFIX, MIN, MAX)                                               \
    ...
    static FIMO_INLINE_ALWAYS FimoU32 fimo_##AFFIX##_count_ones(T v)                                \
    {                                                                                               \
        return fimo_impl_count_ones_##AFFIX(v);                                                     \
    }                                                                                               \
    static FIMO_INLINE_ALWAYS FimoU32 fimo_##AFFIX##_count_zeros(T v)                               \
    {                                                                                               \
        return fimo_##AFFIX##_count_ones((T)~v);                                                    \
    }
