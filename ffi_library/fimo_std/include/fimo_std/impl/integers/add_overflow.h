...
{
    return FIMO_ISIZE_SWITCH_(fimo_impl_add_overflow, a, b, c);
}
...
{
    return FIMO_INTPTR_SWITCH_(fimo_impl_add_overflow, a, b, c);
}
...
{
    return FIMO_USIZE_SWITCH_(fimo_impl_add_overflow, a, b, c);
}
...
{
    return FIMO_UINTPTR_SWITCH_(fimo_impl_add_overflow, a, b, c);
}
