...
typedef enum FimoTracingEvent : FimoU32 {
    ...
    FIMO_TRACING_EVENT_DECLARE_EVENT_INFO,
    FIMO_TRACING_EVENT_START_THREAD,
    FIMO_TRACING_EVENT_STOP_THREAD,
    FIMO_TRACING_EVENT_LOAD_IMAGE,
    FIMO_TRACING_EVENT_UNLOAD_IMAGE,
    FIMO_TRACING_EVENT_CONTEXT_SWITCH,
    FIMO_TRACING_EVENT_THREAD_WAKEUP,
    FIMO_TRACING_EVENT_CALL_STACK_SAMPLE,
} FimoTracingEvent;
