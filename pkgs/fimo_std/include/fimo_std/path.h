...
///
/// On Posix systems, the string encoding is unspecified. On Windows systems, the strings are
/// encoded as UTF-16. The string is null-terminated.
...
///
/// Is equivalent to `fimo_utf8_path_buf_push_path(buf, fimo_utf8_path_new(path))`.
FIMO_EXPORT
FIMO_MUST_USE
