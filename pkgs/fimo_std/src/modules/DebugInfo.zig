...
pub const TypeTag = enum(i32) {
    void = c.FIMO_MODULES_DEBUG_INFO_TYPE_TAG_VOID,
    bool = c.FIMO_MODULES_DEBUG_INFO_TYPE_TAG_BOOL,
    int = c.FIMO_MODULES_DEBUG_INFO_TYPE_TAG_INT,
    float = c.FIMO_MODULES_DEBUG_INFO_TYPE_TAG_FLOAT,
    pointer = c.FIMO_MODULES_DEBUG_INFO_TYPE_TAG_POINTER,
    array = c.FIMO_MODULES_DEBUG_INFO_TYPE_TAG_ARRAY,
    @"struct" = c.FIMO_MODULES_DEBUG_INFO_TYPE_TAG_STRUCT,
    @"enum" = c.FIMO_MODULES_DEBUG_INFO_TYPE_TAG_ENUM,
    @"union" = c.FIMO_MODULES_DEBUG_INFO_TYPE_TAG_UNION,
    @"fn" = c.FIMO_MODULES_DEBUG_INFO_TYPE_TAG_FN,
    @"opaque" = c.FIMO_MODULES_DEBUG_INFO_TYPE_TAG_OPAQUE,
    _,
};
...
pub const FnType = extern struct {
    ...
    pub const CallingConvention = enum(i32) {
        x86_64_sysv = c.FIMO_MODULES_DEBUG_INFO_CALLING_CONVENTION_X86_64_SYSV,
        x86_64_win = c.FIMO_MODULES_DEBUG_INFO_CALLING_CONVENTION_X86_64_WIN,
        aarch64_aapcs = c.FIMO_MODULES_DEBUG_INFO_CALLING_CONVENTION_AARCH64_AAPCS,
        aarch64_aapcs_darwin = c.FIMO_MODULES_DEBUG_INFO_CALLING_CONVENTION_AARCH64_AAPCS_DARWIN,
        aarch64_aapcs_win = c.FIMO_MODULES_DEBUG_INFO_CALLING_CONVENTION_AARCH64_AAPCS_WIN,
        _,
    };
